...
const GuildTypeResponseSchema = z
	.enum(['server', 'community'])
	.optional()
	.default('server')
	.describe('Whether the guild is a server or a community');
...
export const GuildResponse = z.object({
	...
	guild_type: GuildTypeResponseSchema,
...
export interface Guild {
	...
	readonly guild_type?: 'server' | 'community';
