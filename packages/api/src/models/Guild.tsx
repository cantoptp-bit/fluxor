...
import type {GuildRow, GuildType} from '@fluxer/api/src/database/types/GuildTypes';
...
export class Guild {
	...
	constructor(row: GuildRow) {
		...
		this.name = row.name;
		// Legacy guilds (null) default to 'community' so they appear under Communities; only guilds created as "Create Server" have guild_type 'server'.
	this.guildType = row.guild_type ?? 'community';
