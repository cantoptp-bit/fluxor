...
export async function createAPIApp(options: CreateAPIAppOptions): Promise<APIAppResult> {
	...
	const allowedOriginList = [
		...
		'https://fluxor-rust.vercel.app',
	].filter((o, i, a) => a.indexOf(o) === i);
	const productionCorsOrigins = (origin: string): boolean =>
	...
	app.get('/ping-test', (ctx) => ctx.text('pong'));
	app.get('/discovery-test', (ctx) => ctx.json({ ok: true }));
