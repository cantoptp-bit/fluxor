...
export const TempChats = defineTable<TempChatRow, 'user_id_1' | 'user_id_2'>({
	name: 'temp_chats',
	columns: TEMP_CHAT_COLUMNS,
	primaryKey: ['user_id_1', 'user_id_2'],
});

export const TempChatDeleteRequests = defineTable<
	TempChatDeleteRequestRow,
	'user_id_1' | 'user_id_2' | 'user_id',
	'user_id_1' | 'user_id_2'
>({
	name: 'temp_chat_delete_requests',
	columns: TEMP_CHAT_DELETE_REQUEST_COLUMNS,
	primaryKey: ['user_id_1', 'user_id_2', 'user_id'],
	partitionKey: ['user_id_1', 'user_id_2'],
});

export const TempChatsByUser = defineTable<
	TempChatByUserRow,
	'user_id' | 'user_id_1' | 'user_id_2',
	'user_id'
>({
	name: 'temp_chats_by_user',
	columns: TEMP_CHAT_BY_USER_COLUMNS,
	primaryKey: ['user_id', 'user_id_1', 'user_id_2'],
	partitionKey: ['user_id'],
});

export const TempChatMessages = defineTable<
	TempChatMessageRow,
	'user_id_1' | 'user_id_2' | 'message_id',
	'user_id_1' | 'user_id_2'
>({
	name: 'temp_chat_messages',
