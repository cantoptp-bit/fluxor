...
/** Export private key to base64 (PKCS#8) for persistence in sessionStorage. */
...
/** Import private key from base64 (PKCS#8) after restoring from sessionStorage. */
export async function importPrivateKeyFromBase64(base64: string): Promise<CryptoKey> {
	const keyData = base64ToArrayBuffer(base64);
	return await crypto.subtle.importKey('pkcs8', keyData, {name: 'X25519'}, true, ['deriveBits']);
}
