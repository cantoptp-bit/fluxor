...
export const Routes = {
	...
	help: () =>
		typeof window !== 'undefined' ? `${window.location.origin}/help` : marketingUrl('help'),
	helpArticle: (slug: string) =>
		typeof window !== 'undefined'
			? `${window.location.origin}/help/${slug}`
			: marketingUrl(`help/${slug}`),

	dmChannel: (channelId: string) => `/channels/@me/${channelId}`,
	tempChat: (tempChatId: string) => `/channels/@me/temp/${tempChatId}`,
	...
	isTempChatRoute: (pathname: string) => pathname.startsWith('/channels/@me/temp/'),
