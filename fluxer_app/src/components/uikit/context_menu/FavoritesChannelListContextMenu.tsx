...
import {AddFavoriteFriendsModal} from '@app/components/modals/AddFavoriteFriendsModal';
...
import {CreateCategoryIcon, CreateChannelIcon, FavoriteIcon} from '@app/components/uikit/context_menu/ContextMenuIcons';
...
export const FavoritesChannelListContextMenu: React.FC<FavoritesChannelListContextMenuProps> = observer(({onClose}) => {
	...
	const handleFavoriteFriends = useCallback(() => {
		onClose();
		ModalActionCreators.push(modal(() => <AddFavoriteFriendsModal />));
	}, [onClose]);
	...
	return (
		<>
			...
			<MenuGroup>
				...
				<MenuItem icon={<FavoriteIcon />} onClick={handleFavoriteFriends}>
					{t`Favorite Friends`}
				</MenuItem>
