...
import styles from '@app/components/layout/AuthLayoutV6.module.css';

const noop = (_: unknown) => {};

const AuthLayoutV6Content = observer(function AuthLayoutV6Content({ children }: { children?: ReactNode }) {
...
export const AuthLayoutV6 = observer(function AuthLayoutV6({ children }: { children?: ReactNode }) {
	...
	return (
		<I18nProvider i18n={i18n}>
			<AuthLayoutV6Content>{children}</AuthLayoutV6Content>
		</I18nProvider>
	);
});
