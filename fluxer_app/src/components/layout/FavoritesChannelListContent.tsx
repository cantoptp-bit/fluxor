...
import { CaretDownIcon, HashIcon, PlusIcon, StarIcon, UserPlusIcon } from '@phosphor-icons/react';
		...
		return (
			<Scroller className={styles.channelListScroller} key="favorites-channel-list-empty-scroller">
				<div
					onContextMenu={handleContextMenu}
					role="region"
					aria-label={t`Empty favorites`}
					className={favoritesChannelListStyles.emptyStateContainer}
				>
					<StarIcon weight="fill" className={favoritesChannelListStyles.emptyStateIcon} />
					<div className={favoritesChannelListStyles.emptyStateTextContainer}>
						<h3 className={favoritesChannelListStyles.emptyStateTitle}>{t`No favorites yet`}</h3>
						<p className={favoritesChannelListStyles.emptyStateDescription}>
							{t`Pin your favorite channels and friends here for quick access.`}
						</p>
					</div>
					<Button
						variant="primary"
						small
						className={favoritesChannelListStyles.emptyStateButton}
