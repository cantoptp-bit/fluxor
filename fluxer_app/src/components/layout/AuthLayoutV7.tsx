...
import styles from '@app/components/layout/AuthLayoutV7.module.css';

const noop = (_: unknown) => {};

const AuthLayoutV7Content = observer(function AuthLayoutV7Content({ children }: { children?: ReactNode }) {
				...
				<div className={styles.wrapper}>
					<div className={styles.scroll}>
						<div className={styles.card}>
							...
							<span className={styles.tagline}>Sign in to continue</span>
...
export const AuthLayoutV7 = observer(function AuthLayoutV7({ children }: { children?: ReactNode }) {
	...
	return (
		<I18nProvider i18n={i18n}>
			<AuthLayoutV7Content>{children}</AuthLayoutV7Content>
		</I18nProvider>
	);
});
