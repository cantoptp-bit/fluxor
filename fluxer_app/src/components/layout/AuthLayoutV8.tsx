...
import styles from '@app/components/layout/AuthLayoutV8.module.css';

const noop = (_: unknown) => {};

const AuthLayoutV8Content = observer(function AuthLayoutV8Content({ children }: { children?: ReactNode }) {
				...
				<div className={styles.wrapper}>
					<div className={styles.scroll}>
						<div className={styles.card}>
							<span className={styles.wordmark}>$ pegasus login</span>
							<span className={styles.tagline}>authenticate to continue</span>
...
export const AuthLayoutV8 = observer(function AuthLayoutV8({ children }: { children?: ReactNode }) {
	...
	return (
		<I18nProvider i18n={i18n}>
			<AuthLayoutV8Content>{children}</AuthLayoutV8Content>
		</I18nProvider>
	);
});
