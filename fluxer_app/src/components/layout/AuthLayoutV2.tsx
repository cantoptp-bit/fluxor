...
import styles from '@app/components/layout/AuthLayoutV2.module.css';

const noop = (_: unknown) => {};

const AuthLayoutV2Content = observer(function AuthLayoutV2Content({ children }: { children?: ReactNode }) {
...
export const AuthLayoutV2 = observer(function AuthLayoutV2({ children }: { children?: ReactNode }) {
	...
	return (
		<I18nProvider i18n={i18n}>
			<AuthLayoutV2Content>{children}</AuthLayoutV2Content>
		</I18nProvider>
	);
});
