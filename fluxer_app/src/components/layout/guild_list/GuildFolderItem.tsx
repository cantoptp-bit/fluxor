...
export const GuildFolderItem = observer(
	({folder, guilds, onGuildDrop, onDragStateChange, disableDrag = false}: GuildFolderItemProps) => {
	const {t} = useLingui();
	...
	const [{isDragging}, dragRef, preview] = useDrag(
		() => ({
			...
			canDrag: !mobileLayout.enabled && !disableDrag,
	...
	const [{isOver}, dropRef] = useDrop(
		...
		[disableDrag, folderId, onGuildDrop],
	);
