...
import {DevFriendsModal} from '@app/components/modals/tabs/developer_options_tab/DevFriendsModal';
...
export const ToolsTabContent: React.FC<ToolsTabContentProps> = observer(({socket}) => {
	...
	return (
		<>
			<SettingsSection id="feature_test" title={<Trans>Feature test</Trans>}>
				<div className={styles.buttonGroup}>
					<Button
						onClick={() => {
							RouterUtils.transitionTo(Routes.REPORT);
						}}
					>
						{t`Open Report flow`}
					</Button>
					<Button
						onClick={() => {
							ModalActionCreators.push(ModalActionCreators.modal(() => <AddGuildModal initialView="create_server" />));
						}}
					>
						{t`Create Server`}
					</Button>
					<Button
						onClick={() => {
							ModalActionCreators.push(ModalActionCreators.modal(() => <AddGuildModal initialView="create_guild" />));
						}}
					>
						{t`Create Community`}
					</Button>
					<Button
						onClick={() => {
							ModalActionCreators.push(ModalActionCreators.modal(() => <UserSettingsModal initialTab="voice_video" />));
						}}
					>
					...
					<Button
						onClick={() => {
							const channelId = NavigationStore.channelId ?? '';
							ModalActionCreators.push(ModalActionCreators.modal(() => <InviteModal channelId={channelId} />));
						}}
					>
						{t`Invite (current channel)`}
					</Button>
					<Button
						onClick={() => {
							ModalActionCreators.push(
								ModalActionCreators.modal(() => <InboxPopout initialTab="scheduled" />),
							);
						}}
					>
					...
					<Button
						onClick={() => {
							ModalActionCreators.push(ModalActionCreators.modal(() => <UserSettingsModal initialTab="expression_packs" />));
						}}
					>
						{t`Expression packs`}
					</Button>
			...
			<SettingsSection id="tools" title={<Trans>Tools</Trans>}>
				<div className={styles.buttonGroup}>
					<Button
						onClick={() => {
							ModalActionCreators.push(ModalActionCreators.modal(() => <DevFriendsModal />));
						}}
					>
						{t`Manage friends (dev)`}
					</Button>
