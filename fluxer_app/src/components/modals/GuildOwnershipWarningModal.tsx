		...
		<Modal.Root size="small" centered>
			...
			<Modal.Content>
				<div className={styles.content}>
					<p>
						{ownedGuilds[0]?.guildType === 'server' ? (
							<Trans>
								You cannot delete your account while you own servers. Please transfer ownership of the following
								servers first:
							</Trans>
						) : (
							<Trans>
					...
					<p className={styles.helpText}>
						{ownedGuilds[0]?.guildType === 'server' ? (
							<Trans>
								To transfer ownership, go to Server Settings → Overview and use the Transfer Ownership option.
							</Trans>
						) : (
							<Trans>
